...
class SalesRepository
{
     ...
     * @return mixed
     */
    public function getProspectComments(int $prospectId)
    {
        return ProspectComment::where('prospect_id', '=', $prospectId)->get();
    }
     ...
     * @return mixed
     */
    public function createProspectComment(int $prospectId, int $admin_id, string $upload, string $date, string $comment, string $description)
    {
        return ProspectComment::create([
     ...
     * @return mixed
     */
    public function updateProspectTimestamp($prospectId)
    {
        $prospect = Prospect::whereId($prospectId)->first();
        return $prospect->touch();
    }
}