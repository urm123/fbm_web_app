...
FROM admins
  INNER JOIN users ON admins.user_id = users.id WHERE admins.deleted_at IS NULL;"));
     ...
     * @return mixed
     */
    public function addNewAdministrator($username = '', $password = '', $email = '', $first_name = '', $last_name = '', $street_number = '', $street_name = '', $city = '', $postal_code = '', $telephone = '', $mobile = '', $agreement_start = '', $level = '', $initial_password = '')
    {
        $user = User::create([
            'name' => $username,
            'password' => $password,
...
WHERE inspector_id = $inspector_id and clients.deleted_at is NULL "));
     ...
     * @return mixed
     */
    public function addNewCleaner($username = '', $password = '', $email = '', $first_name = '', $last_name = '', $street_number = '', $street_name = '', $city = '', $postal_code = '', $telephone = '', $mobile = '', $start_date = '', $type = true, $role = '')
    {
        $user = User::create([
            'name' => $username,
...
//    }
     ...
     * @return mixed
     */
    public function addNewInspector($username = '', $password = '', $email = '', $first_name = '', $last_name = '', $street_number = '', $street_name = '', $city = '', $postal_code = '', $telephone = '', $mobile = '', $start_date = '', $level = 'INSPECTOR_1')
    {
        $user = User::create([
            'name' => $username,
            'password' => bcrypt($password),
