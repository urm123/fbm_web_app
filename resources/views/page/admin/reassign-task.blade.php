...
@section('content')
                    ...
                    <div class="card form-card">
                            ...
                            <div class="col-md-7">
                                <div class="panel-heading" style="margin-left: -30px;">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li :class="{'active':!repeat}"><a @click="setRepeat(false)" href="#notifi-tab1"
                                                                           data-toggle="tab">One Time</a></li>
                                        <li :class="{'active':repeat}"><a @click="setRepeat(true)" href="#notifi-tab2"
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div>
                                    <div class="content" id="notifi-tab1"
                                         style="overflow:visible;min-height:450px;">

                                        <form id="create-new-cleaner" method="post" class="form-horizontal"
                                              action="{{URL::to('/admin/clients/tasks/post-reallocate-tasks')}}">
                                            {{csrf_field()}}
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control inputdate"
                                                               ...
                                                               value="{{\Carbon\Carbon::parse($task->start_time)->toDateString()}}">
                                        ...
                                        <strong>@{{ validation.start_date[0] }}</strong>
                                                ...
                                                <div v-if="!repeat"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control inputdate"
                                                               ...
                                                               value="{{\Carbon\Carbon::parse($task->end_time)->toDateString()}}">
                                                    </div>
                                                </div>
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="form-control selectpicker" id="cleaner"
                                                                name="cleaner[]" v-model="cleaner_id">
                                                ...
                                                <div v-for="(cleaner_field,index) in cleaner_array"
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control selectpicker add-cleaner"
                                                                name="cleaner[]" v-model="cleaner_field.cleaner_id"
                                                                :id="'cleaner-'+cleaner_field.cleaner_id">
                                                        ...
                                                        <span class="help-block"
                                                              v-if="validation['cleaner.'+addOneToIndex(index)]">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div v-if="repeat"
                                                     class="form-group" :class="{'has-error':validation.repeat_mode}">
                                                    <label class="col-sm-4 control-label"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control" id="repeat_mode"
                                                                name="repeat_mode"
                                                                :disabled="!repeat"
                                                                @change.prevent="setWeekdays($event)"
                                                                :class="{'select-days':weekdays_trigger}">
                                                        <option value="">Select a frequency to repeated tasks
                                                        </option>
                                                        <option @if($task->repeat_mode=='weekdays') selected="selected"
                                                                @endif value="weekdays">Select Days
                                                        </option>
                                                        <option @if($task->repeat_mode=='weekly') selected="selected"
                                                                @endif value="weekly">Weekly
                                                        </option>
                                                        <option @if($task->repeat_mode=='monthly') selected="selected"
                                                                @endif value="monthly">Monthly
                                                        </option>
                                                        <option @if($task->repeat_mode=='semiannually') selected="selected"
                                                                @endif value="semiannually">Semiannually
                                                        </option>
                                                        <option @if($task->repeat_mode=='annually') selected="selected"
                                                                @endif value="annually">Annually
                                                        </option>
                                                        </select>
                                                        <button type="button" class="btn btn-success pull-left"
                                                                v-if="weekdays_trigger"
                                                                @click.prevent="clickWeekdays($event)">Change Days
                                                        </button>
                                                ...
                                                <div v-if="!repeat"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control" id="repeat_mode"
                                                            ...
                                                            <option @if($task->repeat_mode=='3 months') selected="selected"
                                                                    @endif value="3 months">3 months
                                                            </option>
                                                            <option @if($task->repeat_mode=='6 months') selected="selected"
                                                                    @endif value="6 months">6 months
                                                            </option>
                                                            <option @if($task->repeat_mode=='1 year') selected="selected"
                                                                    @endif value="1 year">1 year
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control inputtime"
                                                               ...
                                                               value="{{\Carbon\Carbon::parse($task->start_time)->format('g:i A')}}">
                                        ...
                                        <strong>@{{ validation.start_time[0] }}</strong>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label" for="end_time">End
                                                        Time</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control inputtime"
                                                               id="end_time" name="end_time"
                                                               value="{{\Carbon\Carbon::parse($task->end_time)->format('g:i A')}}">
                                                    </div>
                                                </div>
                                                <div class="form-group"
                                                     :class="{'has-error':validation['inspector.0']}">
                                                    <label class="col-sm-4 control-label"
                                                           for="inspector">Inspector</label>
                                                    <div class="col-sm-6">
                                                        <select class="form-control selectpicker" id="inspector"
                                                                name="inspector[]" v-model="inspector_id">
                                                            <option v-for="inspector in inspectors"
                                                                    :value="inspector.id">@{{inspector.first_name}}
                                                                @{{inspector.last_name}}
                                        ...
                                        <strong>@{{ validation['inspector.0'][0] }}</strong>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <a href="#" @click="addInspector($event)"
                                                           class="btn btn-success"><i class="fa fa-plus">
                                                            </i>
                                                        </a>
                                                    </div>
                                                ...
                                                <div v-for="(inspector_field,index) in inspector_array"
                                                     class="form-group"
                                                     :class="{'has-error':validation['inspector.'+addOneToIndex(index)]}"
                                                     v-if="index>0">
                                                    <label class="col-sm-4 control-label"
                                                           for="inspector">&nbsp;</label>
                                                    <div class="col-sm-6">
                                                        <i class="fa fa-spinner fa fa-spin"></i>
                                                        <select class="form-control selectpicker add-inspector"
                                                                name="inspector[]"
                                                                v-model="inspector_field.inspector_id"
                                                                :id="'inspector-'+inspector_field.inspector_id">
                                                        ...
                                                        <span class="help-block"
                                                              v-if="validation['inspector.'+addOneToIndex(index)]">
                                                <strong>@{{ validation['inspector.'+addOneToIndex(index)][0] }}</strong>
                                                </span>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <a href="#" @click="removeInspector(index, $event)"
                                                           class="btn btn-danger"><i class="fa fa-close">
                                                            </i>
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="col-xs-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tr v-for="(task_item, element) in task_items">
                                                        <td style="width:75%;">
                                                            <input type="text" class="form-control grid-input"
                                                                   name="task_items[]"
                                                                   v-model="task_item.name">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-danger"
                                                                    @click="removeTaskItem(element)"
                                                                    style="font-size: 18px; line-height: 0; padding: 0 11px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-success"
                                                                    @click="addTaskItem"
                                                                    style="font-size: 18px; line-height: 0; padding: 0 9px;">
    ...
    <script type="text/javascript">
        ...
        var data = {
            repeat: false,
            task_items: {!! json_encode($task_items) !!},
            tasks: {!! json_encode($task_items) !!},
            tasks_loaded: false,
            address: '{{$task->address}}',
            inspectors:{!! json_encode($inspectors) !!},
            cleaners:{!! json_encode($cleaners) !!},
            inspector_array: {!! json_encode($task->inspectors) !!},
            cleaner_array: {!! json_encode($task->cleaners) !!},
            validation: [
                {client: []},
                {name: []},
                {start_date: []},
            ...
            selected_dates:{!! json_encode($task->selected_dates) !!},
        ...
        var allocations = new Vue({
            ...
            methods: {
                        ...
                        .then(function (response) {
                            if (response.data.message == 'Failed') {
                                ...
                                $this.validation = {
                                    ...
                                    task_items: [],
                                    inspector: [],
                                    cleaner: ['Cleaners cannot be empty. Please add atleast one cleaner.'],
                                    repeat_mode: [],
                                };
                                jQuery('#button').removeAttr('disabled');
                                ...
                                $this.validation = {
                                    ...
                                    address: [],
                                    task_items: [],
                                    inspector: ['Inspectors cannot be empty. Please add atleast one inspector.'],
                                    cleaner: [],
                                    repeat_mode: [],
                                };
                                jQuery('#button').removeAttr('disabled');
                ...
                addInspector: function (event) {
                    ...
                    this.inspector_array.push({id: id, value: '', inspector_id: id});
                    setTimeout(function () {
                        jQuery('.fa-spin').remove();
                ...
                addCleaner: function (event) {
                    ...
                    var vm = this;
                    var id = new Date().getTime();
                    this.cleaner_array.push({id: id, value: '', cleaner_id: id});
                    setTimeout(function () {
                        jQuery('.fa-spin').remove();
